...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\snippify on
     Windows, /home/user/dev/snippify on Linux) in a file named
     snippify@alexandru.plugaru and copy that file to
